# Clínica Saúde — Sistema de Agendamento

**Estrutura Analítica do Projeto (EAP)**  
Sistematização — Desenvolvimento de Soluções Tecnológicas

| Campo | Informação |
|---|---|
| Aluno | Cláudio Francisco Sobral |
| Curso | Análise e Desenvolvimento de Sistemas — UniCEUB |
| Disciplina | Sistematização do Desenvolvimento de Software |
| Projeto | Projeto 04 — Banco de Dados e Containers |
| Data de entrega | 19 de abril de 2026 |
| Repositório | github.com/claudiofsobral/clinica_saude_frontend |
...
## 2. Marcos e Cronograma

| Marco | Prazo | Descrição |
|---|---|---|
| Marco 1 | Semana 3 | Elaboração da EAP e planejamento de implementação |
| Marco 2 | Semana 6 | Projeto parcialmente implementado e pronto para testes |
| Marco 3 | Semana 9 | Projeto finalizado com entregáveis publicados |
...
|---|---|---|
| Frontend | HTML5 / CSS3 / JavaScript | Interface do usuário e interatividade |
| Frontend | Bootstrap 5 | Layout responsivo e componentes visuais |
| Backend | PHP 8 | Lógica de negócio e API REST |
| Banco de Dados | PostgreSQL | Persistência dos agendamentos |
...
| Entregável | URL |
|---|---|
| Landing Page (GitHub Pages) | https://claudiofsobral.github.io/clinica_saude_frontend/index.html |
| Repositório Frontend | https://github.com/claudiofsobral/clinica_saude_frontend |
| Repositório Backend | https://github.com/claudiofsobral/clinica_saude_backend |
| Vídeo demonstrativo | YouTube — link a ser inserido após gravação |
